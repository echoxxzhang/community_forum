...
public class EventConsumer implements CommunityConstant {
    ...
    public void handlePublishMessage(ConsumerRecord record) {
        ...
        elasticsearchService.saveDiscussPost(post);  // 将该贴添加/更新到es服务器中
    }
    ...
    public void handleDeleteMessage(ConsumerRecord record) {
        ...
        elasticsearchService.deleteDiscussPost(event.getEntityId());  // 将该贴从es服务器中删除
    }
    ...
    public void handleShareMessage(ConsumerRecord record) {
        ...
        Future future = taskScheduler.scheduleAtFixedRate(task, 500); // 每0.5执行一次
    ...
    class UploadTask implements Runnable {
        ...
        public void run() {
            ...
            String path = wkImageStorage + "/" + fileName + suffix;  // 本地路径,将其上传到七牛云
